(function(){"use strict";const select=(el,all=!1)=>{el=el.trim()
    ...
    if(selectHeader){const headerScrolled=()=>{if(window.scrollY>30){selectHeader.classList.add('header-scrolled')}else{selectHeader.classList.remove('header-scrolled')}}
